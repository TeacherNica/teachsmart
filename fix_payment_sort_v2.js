...
console.log('=== Adding date sort within month groups ===');

const oldLine = '  // Sort newest first\r\n  var sortedKeys=Object.keys(groups).sort().reverse();';
const newLine = '  // Sort newest first\r\n  var sortedKeys=Object.keys(groups).sort().reverse();\r\n  // Sort vouchers within each month by date descending\r\n  sortedKeys.forEach(function(k){\r\n    groups[k].payments.sort(function(a,b){ return new Date(b.date)-new Date(a.date); });\r\n  });';
...
console.log('✅ Date sort added within each month group');
...
console.log('\ndone: true');
console.log('✅ Vouchers now sorted newest-first within each month!');
